...
class _$UserRecordSerializer implements StructuredSerializer<UserRecord> {
  ...
  UserRecord deserialize(Serializers serializers, Iterable<Object> serialized,
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'plassword':
          result.plassword = serializers.deserialize(value,
        ...
        $jc(
            $jc(
                $jc(
                    $jc(
                        $jc(
                            $jc($jc($jc(0, plassword.hashCode), name.hashCode),
                                email.hashCode),
...
class UserRecordBuilder implements Builder<UserRecord, UserRecordBuilder> {
  ...
  String _plassword;
  String get plassword => _$this._plassword;
  set plassword(String plassword) => _$this._plassword = plassword;
